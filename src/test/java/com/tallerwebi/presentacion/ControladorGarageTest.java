...
public class ControladorGarageTest {
    ...
    public void queAlSolicitarLaPantallaDeListarGarageSeMuestreLaVistaListarGaragesConUnaListaVacia() {
        ...
        when(servicioGarage.getPaginacion(1, 3,null, null, null)).thenReturn(garages);
        when(servicioGarage.traerTodos()).thenReturn(garages);

        ModelAndView mav = controladorGarage.inicio(1, 3, null, null, null);
    ...
    public void queSeCalculeCorrectamenteElNumeroDePaginas() {
        ...
        when(servicioGarage.getPaginacion(1, 3, null, null, null)).thenReturn(garagesMock.subList(0, 3));
        ...
        ModelAndView mav = this.controladorGarage.inicio(null, null, null, null, null);
    ...
    public void queAlFiltrarPorTipoVehiculoSeMuestreLaVistaCorrecta() {
        ...
        when(servicioGarage.getPaginacion(1, 3, null, null, null)).thenReturn(garages.subList(0, 3));
        ...
        ModelAndView mav = this.controladorGarage.inicio(1, 3, 1, null, null);
    ...
    public void queSeMuestreListadoDeTiposDeVehiculos() {
        ...
        when(servicioGarage.getPaginacion(1, 3, null, null, null)).thenReturn(Collections.emptyList());
        ...
        ModelAndView mav = this.controladorGarage.inicio(1, 3, null, null, null);
