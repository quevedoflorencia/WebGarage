...
public interface ServicioGarage {
    ...
    List<Garage> getPaginacion(Integer page, Integer size, Integer idTipoVehiculo, String orderByCalificacion, String busqueda);
    Integer obtenerCantidadTotal(Integer idTipoVehiculo, String busqueda);
